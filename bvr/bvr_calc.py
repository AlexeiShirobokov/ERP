...
DEFAULTS = {
    ...
    "boevik": 0.5,               # масса боевика, кг (метка ПТ-П-{масса*1000})
    ...
    "shema": "Схема волновая 42/67",          # схема взрывания
    "avtoVM": "КамАЗ 43118 Х 873 МК 14",       # автотранспорт для ВМ (марка, госномер)
    "voditel": "",                              # водитель спецавтомобиля
    "gendir": "Каздобин А.В.",
    "gling": "Парамонов В.И.",
    "nachbvr": "Сырбу Г.П.",
    "glgeo": "Помалейко А.А.",
    ...
    "nachuch": "Шмелёв С.В.",
    "vzryvnik": "Фурман А.С.",
    "injot": "Сорокин В.В.",      # инженер ОТ и ПБ
    "dispet": "Лахманов А.В.",    # диспетчер АО
    # Лист «Ознакомление»: участники, по одному на строку «ФИО; профессия».
    # Список меняется от взрыва к взрыву — правится в форме.
    "participants": (
        "Лаврентиев Д. М.; Водитель\n"
        "Пикущий Ю. П.; Водитель\n"
        "Коннов Н. Е.; Взрывник\n"
        "Григорьев В. С.; Водитель\n"
        "Фурман А. С.; Взрывник\n"
        "Думолакас Д. В.; Взрывник\n"
        "Гаршин И. Г.; Взрывник\n"
        "Гонин С. В.; Водитель"
    ),
}
