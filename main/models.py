...
class DebitorCase(models.Model):
    ...
    last_report_date = models.CharField(max_length=50, blank=True, null=True, verbose_name="Последняя дата отчета")
    current_date = models.CharField(max_length=50, blank=True, null=True, verbose_name="Дата операции")
    ...
    current_debt_date = models.CharField(max_length=100, blank=True, null=True, verbose_name="Дата образования задолженности")
...
class DebitorSnapshot(models.Model):
    ...
    report_date = models.CharField(max_length=50, verbose_name="Дата отчета")
    date = models.CharField(max_length=50, blank=True, null=True, verbose_name="Дата")
    ...
    debt_date = models.CharField(max_length=100, blank=True, null=True, verbose_name="Дата образования задолженности")
